export const Netsoc = `<p># <span class="yellow underline">UCC Netsoc</span> - <span class="underline">SysAdmin / ExOfficio (September 2017 - May 2019)</span></p>
<p><span class="green">-</span> Introduced Docker to the SysAdmin team and helped move services to using it.</p>
<p><span class="green">-</span> Assisted in the rewrite of the student portal from PHP into Python using Flask.</p>
